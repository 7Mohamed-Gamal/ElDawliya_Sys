...
<head>
    ...
    <style>
        ...
        button[type="submit"]:not([name="test"]) {
...
<body>
    <div class="container">
        ...
        <div class="alert" style="background-color: #e7f3fe; border-right: 5px solid #2196F3; padding: 15px; margin-bottom: 20px;">
            <h4 style="margin-top: 0; color: #0c5460;"><i style="margin-left: 10px;">ℹ️</i>معلومات</h4>
    ...
    if environ['REQUEST_METHOD'] == 'POST':
        ...
        'OPTIONS': {{
            ...
            'Trusted_Connection': 'no',
                        ...
                        # إنشاء صفحة إعادة توجيه مع رسالة نجاح
