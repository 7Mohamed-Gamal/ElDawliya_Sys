...
from apps.procurement.purchase_orders.decorators import MODULES, DEPARTMENT_NAME
...
class PurchasePermissionsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        for module_key, module_name in MODULES.items():
            module = Module.objects.create(
                department=self.purchase_department,
                name=module_name,
    ...
    def test_template_tags(self):
        ...
        from apps.procurement.purchase_orders.templatetags.purchase_permission_tags import has_purchase_module_permission
        ...
        self.assertFalse(has_purchase_module_permission(user_request, 'approvals', 'edit'))
