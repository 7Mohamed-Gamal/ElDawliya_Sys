...
class HRAnalyticsService:
    ...
    def get_attendance_analytics(start_date=None, end_date=None):
        ...
        try:
            from apps.hr.attendance.models import AttendanceRecord, AttendanceSummary
    ...
    def get_payroll_analytics(year=None, month=None):
        ...
        try:
            from apps.hr.payroll.models import PayrollRun, PayrollDetail
...
class EmployeeLifecycleService:
    ...
    def onboard_employee(employee_data, salary_data=None, attendance_profile_data=None):
        ...
        try:
            from apps.hr.employees.models import Employee
            from apps.hr.payroll.models import EmployeeSalary
            from apps.hr.attendance.models import EmployeeAttendanceProfile, AttendanceRule
    ...
    def terminate_employee(employee, termination_date=None, reason=None):
        ...
        try:
            ...
            from apps.hr.attendance.models import EmployeeAttendanceProfile
            try:
...
class PayrollCalculationService:
    ...
    def calculate_employee_payroll(employee, period_start, period_end, include_overtime=True):
        ...
        try:
            from apps.hr.payroll.models import EmployeeSalary
            from apps.hr.attendance.models import AttendanceSummary
