...
def dashboard(request):
    ...
    from apps.projects.tasks.models import UnifiedTaskManager
...
def task_list(request):
    ...
    from apps.projects.tasks.models import UnifiedTaskManager
    from apps.projects.tasks.forms import UnifiedTaskFilterForm
...
def task_detail(request, pk):
    ...
    """
    from apps.projects.tasks.models import UnifiedTaskManager
    from apps.projects.tasks.forms import UnifiedTaskStepForm, UnifiedTaskStatusForm, MeetingTaskEditForm
...
def delete_step(request, pk):
    ...
    from apps.projects.meetings.models import MeetingTask, MeetingTaskStep
