...
class UnifiedTask:
    ...
    def get_delete_url(self):
        ...
        if self.task_type == 'regular':
            ...
            # Meeting tasks might not be deletable from apps.projects.tasks interface
            return None
    ...
    def add_step(self, description, notes=None, user=None):
        ...
        if self.task_type == 'regular':
            from apps.projects.tasks.models import TaskStep
            ...
            from apps.projects.meetings.models import MeetingTaskStep
