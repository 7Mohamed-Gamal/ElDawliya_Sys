...
from apps.projects.meetings.decorators import MODULES, DEPARTMENT_NAME
from apps.projects.meetings.models import Meeting

User = get_user_model()

class MeetingsPermissionsTestCase(TestCase):
    """MeetingsPermissionsTestCase class"""
    def setUp(self):
        """setUp function"""
        # Create admin user
    ...
    def test_template_tags(self):
        ...
        from apps.projects.meetings.templatetags.meetings_permission_tags import has_meetings_module_permission
