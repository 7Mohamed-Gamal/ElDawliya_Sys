# Generated by Django 5.0.14 on 2025-04-19 16:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='نشط')),
                ('shift_type', models.CharField(blank=True, choices=[('حضور فقط', 'حضور فقط'), ('انصراف فقط', 'انصراف فقط')], max_length=50, null=True, verbose_name='نوع المناوبة')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currentweekshift', models.CharField(blank=True, db_column='CurrentWeekShift', max_length=50, null=True, verbose_name='مناوبة الأسبوع الحالي')),
                ('nextweekshift', models.CharField(blank=True, db_column='NextWeekShift', max_length=50, null=True, verbose_name='مناوبة الأسبوع القادم')),
                ...
                ('shift_type', models.CharField(blank=True, choices=[('صباحي', 'صباحي'), ('مسائي', 'مسائي'), ('ليلي', 'ليلي')], db_column='Shift_Type', max_length=50, null=True, verbose_name='نوع المناوبة')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='conducted_evaluations', to=settings.AUTH_USER_MODEL, verbose_name='المقيم')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='تاريخ الإنشاء')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='تاريخ التحديث')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='files', to='Hr.employee', verbose_name='الموظف')),
                ('uploaded_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='uploaded_files', to=settings.AUTH_USER_MODEL, verbose_name='تم الرفع بواسطة')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='تاريخ الإنشاء')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='تاريخ التحديث')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='employee_notes', to=settings.AUTH_USER_MODEL, verbose_name='تم الإنشاء بواسطة')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notes', to='Hr.employee', verbose_name='الموظف')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payroll_period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='entries', to='Hr.payrollperiod', verbose_name='فترة الراتب')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='تاريخ الإنشاء')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='تاريخ التحديث')),
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pickup_points', to='Hr.car', verbose_name='السيارة')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payroll_entry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='item_details', to='Hr.payrollentry', verbose_name='سجل الراتب')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='تاريخ الإنشاء')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='تاريخ التحديث')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='salary_items', to='Hr.employee', verbose_name='الموظف')),
                ('salary_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_items', to='Hr.salaryitem', verbose_name='بند الراتب')),
            ],
            options={
